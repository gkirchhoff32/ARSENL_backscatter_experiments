...
use_ref = False  # Set TRUE if using reference dataset to generate evaluation loss value

window_bnd = [28e-7, 34e-7]  # [s] Set boundaries for binning to exclude outliers
if use_sim:
